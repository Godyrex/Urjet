...
<td>
					<form method="POST" action="modifier_voyage.php">
						<input type="submit" name="Modifier" value="Modifier">
						<input type="hidden" value=<?PHP echo $voyage['idrec']; ?> name="idrec">
					</form>
				</td>
				<td>
					<a href="supprimer_voyage.php?idrec=<?php echo $voyage['idrec']; ?>">Supprimer</a>
				</td>
