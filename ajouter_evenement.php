...
<?php
    ...
    if ( isset($_POST["nom"]) && isset($_POST["debut"]) && isset($_POST["fin"]) )
    
    {
        if ( !empty($_POST["nom"]) && isset($_POST["debut"])  && isset($_POST["fin"]) )
         {
...
-->
  ...
  <button type="button" class="form-control" onclick="myFunction2();myFunction();">Verifier les données</button> 
										  ...
										  <button type="submit" class="form-control" id="submit-button-rv"  name="submit">evenement</button>
									  </form>
					</section>
