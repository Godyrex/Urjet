			...
			if (isset($_POST['id_voyage']))
      {
        ...
        <div class="card-body table-responsive p-0">
                ...
                <tr class="col-lg-20 connectedSortable">
                    <td>
                        <label for="id_voyage">Id du voyage:
                        </label>
                    </td>
                ...
                <tr  class="col-lg-20 connectedSortable">
                    ...
                    <td><input type="time" name="heure_depart" id="heure_depart" value="<?php echo $voyage['heure_depart']; ?>" maxlength="20"></td>
                </tr>
                ...
                <tr  class="col-lg-20 connectedSortable">
                    ...
                    <td><input type="time" name="heure_arrivee" id="heure_arrivee" value="<?php echo $voyage['heure_arrivee']; ?>" maxlength="20"></td>
                </tr>
