...
{
    $key = $_POST['key'];
    $sql="SELECT *FROM reclamation WHERE idrec LIKE :keyword OR diagnostic LIKE :keyword OR urgence LIKE :keyword ORDER BY idrec";
...
<html>
	<head>
		<title>Demande de reclamation</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		...
		<!-- Page Wrapper -->
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header">
						<h1><a href="indexBack.php">Urjet</a></h1>
						<nav id="nav">
							<ul>
								<li class="special">
									...
									<div id="menu">
										<ul>
										<li><a href="indexBack.php">Accueil (airplanes catalog)</a></li>
											...
											<li><a href="ajoutereponse.php">Réponse</a></li>
											<li><a href="Maintence.php"></a>Afficher la liste des demandes</li>
				...
				<!-- Main -->
					<article id="main">
						<header>
							<h2>Demande de reclamation</h2>
							<p>Liste des reponses</p>
						</header>
						<section class="wrapper style5">
							<div class="inner">
                            <form action="rechercherreclamation.php" method="post" >
