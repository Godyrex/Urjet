      ...
      <section class="content">
		...
		<table id="myTable" class="table table-head-fixed text-nowrap ">
			...
			<td><?php echo $maintenance['IDM']; ?></td>
				...
				<td>
					<form method="POST" action="modifiermaintenance.php">
						<input type="submit" name="Modifier" value="Modifier">
						<input type="hidden" value=<?PHP echo $maintenance['IDM']; ?> name="IDM">
					</form>
				</td>
				<td>
					<a href="supprimermaintenance.php?IDdemande=<?php echo $maintenance['IDdemande']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
