...
function ajoutt() {
    var typea = document.forms["typef"]["typea"].value;
    var errort = 1;
    var errortypea = document.getElementById('errortypea');
    if (typea == "") {
        errortypea.innerHTML = "type a valid type  ";
        errort = 1;
    } else {
        errort = 0;
        errortypea.innerHTML = "";
    }
