...
if (isset($_POST["recherche"])) {
  // if($_SERVER["REQUEST_METHOD"] == "POST"){
  $key = $_POST["recherche1"];
  header('Location: recherche.php?id='.$key);
  //header("Refresh:0");
}
?>
<!DOCTYPE html>
                ...
                <div class="col-12">
                  <div class="card">
                    ...
                    <div class="input-group input-group-sm" style="width: 150px;">
                      <input type="text" name="recherche1" id="recherche1" class="form-control float-right" placeholder="recherche">
                      <div class="input-group-append">
                        <button type="submit" name="recherche" class="btn btn-default">
                          <i class="fas fa-search"></i>
                        </button>
                      </div>
                    </div>
