                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?php echo $userc->usercountsearch($key); ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number"><?php echo $userc->bancountsearch($key); ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                                ...
                                <div class="card-tools"> 
                                    <form id="searchform" >
                                        ...
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <input value="<?php echo $_GET['search1']?>" type="text" name="search1" id="search1" class="form-control float-right" placeholder="Search">
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-default">
                                                    <i class="fas fa-search"></i>
                                                </button>
                                                <button class="btn btn-default">
                                                <a href="AdminPanel.php" class="fas fa-spinner"></a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
