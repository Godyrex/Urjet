...
session_start();
    ...
    include_once '../Controller/MaintenanceC.php';
    ...
    if (
        ...
        if (
            ...
            $maintenanceC->ajoutermaintenance($maintenance);
      ...
      <section class="content">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title">Veuillez remplir le formulaire suivant</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="prix" id="prix" placeholder="Enter le prix">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputtext2">etat</label>
                    <input type="text" name="etat" id="etat" placeholder="entrer l'etat de la maintenance">
                  </div>
