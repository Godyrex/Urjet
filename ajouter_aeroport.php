...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/URJETLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <form action="" method="POST">
            <table border="1" align="center">
				...
				<tr>
                    ...
                    <td><input type="text" name="depart" id="depart" maxlength="10"></td>
                </tr>
                <tr>
                    <td>
