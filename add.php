...
$sql = "INSERT INTO `avion` (`id`, `nom`, `type`,`prix`,`photo`) VALUES ('$id', '$nom', '$type','$prix','$photo')"; 
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Add Airplane</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input name="prix" onblur="ajout()" onkeyup="ajout()" type="number" class="form-control" id="prix"
                              placeholder="number">
